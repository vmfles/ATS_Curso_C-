/*
Vídeos nº 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121 y 122 del curso de YOUTUBE "Programación en C++ (Programación ATS)"
Árboles - Definiciones
Nodo, raíz, ramas, hojas
Longitud del camino:
Profundidad:
Nivel
Nodos hermanos:
...
Árbol binario es una estructura recursiva que se divide en 3 subconjuntos:
 - Nodo raíz.
 - Subárbol izquierdo
 - Subárbol derecho

Tipos de árboles binarios:
 - Arbol lleno: todos sus nodos tienen sus 2 hijos, excepto en el último nivel (hojas)
 - Árbol completo: hay nodos hijos a diferentes niveles
 - Árbol degenerado: cada hijo sólo tiene 1 hijo (es igual que una lista enlazada)

Árbol binario de búsqueda
Es aquel árbol que dado un nodo, todos los datos del subárbol izquierdo son menores,
